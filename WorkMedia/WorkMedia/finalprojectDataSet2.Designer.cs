...
namespace WorkMedia.finalprojectDataSet2TableAdapters {
...
SELECT id, username, first_name, last_name, password, IsAdmin FROM users WHERE (id = @id)";
        ...
        public virtual int Fill(finalprojectDataSet2.usersDataTable dataTable) {
        ...
        public virtual finalprojectDataSet2.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            finalprojectDataSet2.usersDataTable dataTable = new finalprojectDataSet2.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(finalprojectDataSet2.usersDataTable dataTable) {
