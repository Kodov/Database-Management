...
namespace WorkMedia {
    ...
    public partial class finalprojectDataSet : global::System.Data.DataSet {
        ...
        public partial class LogsDataTable : global::System.Data.TypedTableBase<LogsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LogsRow AddLogsRow(int user_id, string action, System.DateTime login, System.DateTime logout) {
        ...
        public partial class LogsRow : global::System.Data.DataRow {
            ...
            public System.DateTime login {
                get {
                    return ((global::System.DateTime)(this[this.tableLogs.loginColumn]));
                }
                set {
            ...
            public System.DateTime logout {
                get {
                    return ((global::System.DateTime)(this[this.tableLogs.logoutColumn]));
                }
                set {
...
namespace WorkMedia.finalprojectDataSetTableAdapters {
    ...
    public partial class LogsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Logs] WHERE (([id] = @Original_id) AND ([user_id] = @Original_" +
                "user_id) AND ((@IsNull_action = 1 AND [action] IS NULL) OR ([action] = @Original" +
                "_action)) AND ([login] = @Original_login) AND ([logout] = @Original_logout))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Logs] ([user_id], [action], [login], [logout]) VALUES (@user_i" +
                "d, @action, @login, @logout);\r\nSELECT id, user_id, action, login, logout FROM Lo" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Logs] SET [user_id] = @user_id, [action] = @action, [login] = @login, [logout] = @logout WHERE (([id] = @Original_id) AND ([user_id] = @Original_user_id) AND ((@IsNull_action = 1 AND [action] IS NULL) OR ([action] = @Original_action)) AND ([login] = @Original_login) AND ([logout] = @Original_logout));
SELECT id, user_id, action, login, logout FROM Logs WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, user_id, action, login, logout FROM dbo.Logs";
        ...
        public virtual int Fill(finalprojectDataSet.LogsDataTable dataTable) {
        ...
        public virtual finalprojectDataSet.LogsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            finalprojectDataSet.LogsDataTable dataTable = new finalprojectDataSet.LogsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(finalprojectDataSet.LogsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, int Original_user_id, string Original_action, System.DateTime Original_login, System.DateTime Original_logout) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((System.DateTime)(Original_login));
            this.Adapter.DeleteCommand.Parameters[5].Value = ((System.DateTime)(Original_logout));
        ...
        public virtual int Insert(int user_id, string action, System.DateTime login, System.DateTime logout) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((System.DateTime)(login));
            this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(logout));
        ...
        public virtual int Update(int user_id, string action, System.DateTime login, System.DateTime logout, int Original_id, int Original_user_id, string Original_action, System.DateTime Original_login, System.DateTime Original_logout, int id) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((System.DateTime)(login));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(logout));
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(Original_login));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.DateTime)(Original_logout));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int user_id, string action, System.DateTime login, System.DateTime logout, int Original_id, int Original_user_id, string Original_action, System.DateTime Original_login, System.DateTime Original_logout) {
            return this.Update(user_id, action, login, logout, Original_id, Original_user_id, Original_action, Original_login, Original_logout, Original_id);
        }
    }
